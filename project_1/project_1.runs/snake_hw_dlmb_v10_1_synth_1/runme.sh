...
HD_PWD='W:/snake/project_1/project_1.runs/snake_hw_dlmb_v10_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_hw_dlmb_v10_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_hw_dlmb_v10_1.tcl
