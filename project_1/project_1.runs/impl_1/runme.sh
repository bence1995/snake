...
HD_PWD='W:/snake/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_hw_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source snake_hw_wrapper.tcl -notrace
