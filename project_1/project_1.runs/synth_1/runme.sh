...
HD_PWD='W:/snake/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_hw_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_hw_wrapper.tcl
